...
view model =
  div []
    ...
    , div [ class "contentButtons" ]
        [ div []
            [ img [ src "glass.svg", style [("width", "3rem")], onClick <| ChangeContentTo "200" ] []
            , div [ class "label" ] [ text "200ml" ]
            ]
        , div []
            [ img [ src "cup.svg", style [("width", "4rem")], onClick <| ChangeContentTo "330" ] []
            , div [ class "label" ] [ text "330ml" ]
            ]
        , div []
            [ img [ src "bottle.svg", style [("width", "5rem")], onClick <| ChangeContentTo "500" ] []
